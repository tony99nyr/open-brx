...
| 1, 12, 13, 42 | **the extra-headset word** | ⭐ **NAMED 2026-09-18 from Battle Company's own weapon sheets** (via the LaserTagMods material, Jay's Drive; names are STRONG, the behaviour below is NOT bench-proven). **t1 = `WeaponIRSource`**: 0 gun laser · 1 headset only · **2 gun AND headset** · 3 double gun · 4 double gun + headset · 5 dry fire. **t12 = `ExtraHeadsetDamage`, t13 = `ExtraHeadsetRangeOutdoor`, t42 = `ExtraHeadsetRangeIndoor`** — the damage and reach of a SECOND word the headset's high-power LED emits. Exactly three stock weapons set t1 = 2, and their t12 is a DAMAGE the catalogue does not model: **Shotgun 70** (its `t5` is 45), **Rocket Launcher 115**, **Plasma Sniper 80**; t13 is 80 on all three and t42 is 30/30/40. The community source that explains why: shotguns, melee and explosions leave through the headset LED, and a swap-in headset without that LED "means no shotguns, melee, explosions". ⚠️ **If t12 is what a headset sensor receives, the Shotgun deals 70 there and 45 on the gun body, and FOUR of the five sensors are on the headset** — so its real hits-to-kill would be 2, not the 3 the ladder is built on. UNTESTED, and the test is one shotgun shot at a covered gun sensor versus an exposed headset with the `$HIR` magnitude read both times. Our own melee frame leaves t13 and t42 EMPTY, which is the top suspect for melee's range behaviour |
