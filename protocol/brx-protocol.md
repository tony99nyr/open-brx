...
| `$SIR,9,3,,24,10,0,,,*` | Energy Launcher (fn 24, closed 2026-09-18: the phantom hit generator — see the row above. Deals no damage, and the victim's gun manufactures a fake `$HIR` every 5.07 s until the next `$SPAWN`. P18, excluded from every pool, `policy.UNPLAYABLE_IDS`) |
...
Unknown or unverified: t19 (not simply reloadType), t25/t26 (Suppressor only).
(**t21/t22 accuracy left this list 2026-09-09**, **t2 and t41 on 2026-09-17**, and **t6 crit chance on
2026-09-18** — all bench-proven, see the `$WEAP` table.)
