    ...
    - main [ref=e58]:
      - navigation "Breadcrumb" [ref=e59]:
        ...
        - link "Gameplay" [ref=e64] [cursor=pointer]:
          - /url: /manual/gameplay/
        - generic [ref=e65]: /
        - generic [ref=e66]: Beyond stock — the Open BRX mode catalog
      - article [ref=e67]:
        - generic [ref=e68]:
          - heading "Beyond stock — the Open BRX mode catalog" [level=1] [ref=e69]
          - paragraph [ref=e70]: Because the gun keeps no game state, any rule you can write over hits, teams, health and spawns is a mode. A teaser — the full catalog lives in the platform section.
          - paragraph [ref=e71]:
        ...
        - generic [ref=e80]:
          - paragraph [ref=e81]:
            ...
            - emphasis [ref=e82]: Platform section
            - text: for the architecture.
          - paragraph [ref=e83]:
            - text: "Source:"
            - link "docs/game-modes.md" [ref=e84] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
            - text: ","
            - link "docs/mode-limits.md" [ref=e85] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/mode-limits.md
            - text: ","
            - link "protocol/callsign-extract/protocol-classes.md" [ref=e86] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/callsign-extract/protocol-classes.md
            - text: §What's moddable
        - generic [ref=e87]:
          - heading "Modes by what they need" [level=2] [ref=e88]
          - table [ref=e90]:
            - rowgroup [ref=e91]:
              - row [ref=e92]:
                - columnheader "Tier" [ref=e93]
                - columnheader "What you add" [ref=e94]
                - columnheader "Modes in the catalog" [ref=e95]
            - rowgroup [ref=e96]:
              - row [ref=e97]:
                - cell [ref=e98]:
                  - strong [ref=e99]: Tier 0 — Mission Control alone
                  - text: (taggers + a laptop/phone you own)
                - cell "nothing" [ref=e100]
                - cell [ref=e101]:
                  - text: FFA · Team Death Match · Survival/Infection · The Swarm · Generals · Commander · Supremacy · Last Man Standing ·
                  - strong [ref=e102]: Syphon
                  - text: (health on kill) ·
                  - strong [ref=e103]: Halo-style regenerating health
                  - text: · overshield / medic roles · small-scale
                  - strong [ref=e104]: Extraction
                  - text: · grenade-site
                  - strong [ref=e105]: Counter-Strike
              - row [ref=e106]:
                - cell [ref=e107]:
                  - strong [ref=e108]: Tier 1 — + props
                  - text: (objective stations, flags, QR codes — or the grenade)
                - cell "contested places" [ref=e109]
                - cell [ref=e110]:
                  ...
                  - strong [ref=e111]: Extraction point
              - row [ref=e112]:
                - cell [ref=e113]:
                  - strong [ref=e114]: Tier 2 — + broadcast
                  - text: (a live field-wide downlink; location on each node)
                - cell "live global awareness" [ref=e115]
                - cell "Battle Royale · live scoreboards and \"flag taken!\" callouts on a big no-WiFi field · hidden multi-extracts" [ref=e116]
          - paragraph [ref=e117]:
            - text: "Source:"
            - link "docs/game-modes.md" [ref=e118] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
            - text: §The three infrastructure tiers + §Catalog + §Custom/advanced modes,
            - link "docs/mode-limits.md" [ref=e119] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/mode-limits.md
        - generic [ref=e120]:
          - heading "Three modes stock BRX doesn't ship" [level=2] [ref=e121]
          - list [ref=e123]:
            - listitem [ref=e124]:
              - strong [ref=e125]: Extraction
              - text: — insert, loot, reach an extraction point and
              - emphasis [ref=e126]: channel
              ...
              - generic "Verified on our bench" [ref=e127]: ✅
            - listitem [ref=e129]:
              - strong [ref=e130]: Counter-Strike (plant / defuse)
              ...
              - generic "Verified on our bench" [ref=e131]: ✅
            - listitem [ref=e133]:
              - strong [ref=e134]: Syphon & regenerating health
              ...
              - generic "Verified on our bench" [ref=e135]: ✅
          - paragraph [ref=e137]:
            - text: "Source:"
            - link "docs/game-modes.md" [ref=e138] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
            - text: §Extraction + §Custom/advanced modes + §Health/regen variants,
            - link "mcp/brx_mcp/modes/extraction.py" [ref=e139] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/mcp/brx_mcp/modes/extraction.py
        - note [ref=e141]:
          - strong [ref=e142]: Teams are more flexible than red vs blue.
          - paragraph [ref=e143]: The hardware supports four native teams with on-gun friendly-fire protection and per-team LED colour. For more squads, run everyone as one team with friendly fire on, hand out armbands, and let Mission Control keep the real teams and scores — a technique the owner community proved with clipped ribbon "flags".
          - paragraph [ref=e144]:
            - text: "Source:"
            - link "docs/game-modes.md" [ref=e145] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
            - text: §Team structure,
            - link "docs/reference/community-notes.md" [ref=e146] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/reference/community-notes.md
            - text: §Game-mode design ideas
        - note [ref=e148]:
          - strong [ref=e149]: Honest limits.
          - paragraph [ref=e150]: Phones have no IR, so shoot-the-point needs a station or the grenade; one phone can hold only a handful of gun links; a field without WiFi means live global state needs a radio tier. All of it is designed around, not ignored — the constraints ledger is in the platform section.
          - paragraph [ref=e151]:
            - text: "Source:"
            - link "docs/mode-limits.md" [ref=e152] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/mode-limits.md
            - text: §3
        - generic [ref=e153]:
          - figure "The tier ladder — Tier 0 (laptop + taggers) → Tier 1 (+ stations / grenade) → Tier 2 (+ field broadcast), with representative modes stacked on each rung." [ref=e154]:
            - 'img "Three ascending platforms: a laptop with taggers; plus a small station and a grenade; plus a radio mast — with abstract mode badges stacked on each" [ref=e155]':
              - generic [ref=e156]: GAME-14
              - generic [ref=e157]: diagram pending
          - paragraph [ref=e159]:
            - text: "Source:"
            - link "docs/game-modes.md" [ref=e160] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
    - complementary "On this page" [ref=e161]:
      - generic [ref=e162]:
        - paragraph [ref=e163]: On this page
        - list [ref=e164]:
          - listitem [ref=e165]:
            - link "Modes by what they need" [ref=e166] [cursor=pointer]:
              - /url: "#modes-by-what-they-need"
          - listitem [ref=e167]:
            - link "Three modes stock BRX doesn't ship" [ref=e168] [cursor=pointer]:
              - /url: "#three-modes-stock-brx-doesn-t-ship"
          - listitem [ref=e169]:
            - link "Teams are more flexible than red vs blue." [ref=e170] [cursor=pointer]:
              - /url: "#teams-are-more-flexible-than-red-vs-blue"
          - listitem [ref=e171]:
            - link "Honest limits." [ref=e172] [cursor=pointer]:
              - /url: "#honest-limits"
  - contentinfo [ref=e173]:
    - paragraph [ref=e174]:
      - text: Protocol discovered by
      - link "LaserTagMods" [ref=e175] [cursor=pointer]:
    ...
    - paragraph [ref=e176]:
      ...
      - link "Credits & sourcing" [ref=e177] [cursor=pointer]:
        - /url: /credits/
      - text: ·
      - link "Changelog" [ref=e178] [cursor=pointer]:
        - /url: /changelog/
      - text: ·
      - link "llms.txt" [ref=e179] [cursor=pointer]:
        - /url: /llms.txt
      - text: ·
