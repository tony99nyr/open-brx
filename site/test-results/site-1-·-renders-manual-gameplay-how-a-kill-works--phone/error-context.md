    ...
    - main [ref=e52]:
      - navigation "Breadcrumb" [ref=e53]:
        ...
        - link "Gameplay" [ref=e58] [cursor=pointer]:
          - /url: /manual/gameplay/
        - generic [ref=e59]: /
        - generic [ref=e60]: How a kill actually works
      - article [ref=e61]:
        - generic [ref=e62]:
          - heading "How a kill actually works" [level=1] [ref=e63]
          - paragraph [ref=e64]: From trigger pull to green flash, in five steps — the developer section has the bit layout
          - paragraph [ref=e65]:
            - generic [ref=e66]:
              - text: Last verified
              - time [ref=e67]: 2026-08-27
            - link "View as Markdown" [ref=e68] [cursor=pointer]:
              - /url: /manual/gameplay/how-a-kill-works.md
          - group [ref=e69]:
            - generic "? What the badges mean" [ref=e70] [cursor=pointer]
        - generic [ref=e71]:
          - paragraph [ref=e72]:
            - text: A BRX "bullet" is a burst of infrared light 25 bits long, sent on a 38 kHz carrier. It carries
            - strong [ref=e73]: who fired (player id), which team, how much damage, and what kind of damage
          ...
          - paragraph [ref=e74]:
            - text: "Source:"
            - link "protocol/brx-ir-protocol.md" [ref=e75] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-ir-protocol.md
            - text: ","
            - link "protocol/brx-protocol.md" [ref=e76] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-protocol.md
            - text: §7o + §7r
        - generic [ref=e77]:
          - 'figure "The kill pipeline: gun → 25-bit IR word → three receivers on the victim → pool subtraction → death → kill-confirm flash back on the shooter." [ref=e78]':
            - 'img "The kill pipeline: tagger emitting a coded burst of light → a headset with front and back domes plus a gun-body sensor → a pool bar dropping → a green sight flash on the shooter" [ref=e79]':
              - generic [ref=e80]: GAME-10
              - generic [ref=e81]: diagram pending
          - paragraph [ref=e83]:
            - text: "Source:"
            - link "protocol/brx-ir-protocol.md" [ref=e84] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-ir-protocol.md
            - text: ","
            - link "protocol/brx-protocol.md" [ref=e85] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-protocol.md
            - text: §7r
        - generic [ref=e86]:
          - heading "The five steps" [level=2] [ref=e87]
          - list [ref=e89]:
            - listitem [ref=e90]:
              - strong [ref=e91]: Fire.
            ...
            - listitem [ref=e92]:
              - strong [ref=e93]: Catch.
              - text: "The target has three receivers: the headset's"
              - strong [ref=e94]: front dome
              - text: ", the headset's"
              - strong [ref=e95]: back dome
              - text: ", and a sensor on the"
              - strong [ref=e96]: gun body
            ...
            - listitem [ref=e101]:
              - strong [ref=e102]: Confirm.
              - text: On a kill the
              - emphasis [ref=e103]: shooter's
          ...
          - paragraph [ref=e104]:
            - text: "Source:"
            - link "protocol/brx-ir-protocol.md" [ref=e105] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-ir-protocol.md
            - text: §Frame + §Field layout,
            - link "protocol/brx-protocol.md" [ref=e106] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-protocol.md
            - text: §7r (sensor map, FF),
            - link "docs/sound-architecture.md" [ref=e107] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/sound-architecture.md
            - text: §Native multikills,
            - link "docs/experiment-log.md" [ref=e108] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/experiment-log.md
            - text: ("headset LED map" 2026-08-27 entries),
            - link "protocol/callsign-extract/protocol-classes.md" [ref=e109] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/callsign-extract/protocol-classes.md
            - text: §FSET
        - note [ref=e111]:
          - strong [ref=e112]: Why misses still make noise.
          - paragraph [ref=e113]: "The manual's \"simulated recoil\" accuracy model means a rapid-fire miss still reaches the enemy: their headset lights and they hear a zip, but 0 damage is applied. If someone's headset is flashing and they are not dying, you are missing — fire in bursts."
          - paragraph [ref=e114]:
            - text: "Source:"
            - link "docs/reference/brx-extended-user-guide.md" [ref=e115] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/reference/brx-extended-user-guide.md
            - text: §Weapons
        - generic [ref=e116]:
          - heading "Feedback you will see and hear" [level=2] [ref=e117]
          - table [ref=e119]:
            - rowgroup [ref=e120]:
              - row [ref=e121]:
                - columnheader "Event" [ref=e122]
                - columnheader "Victim" [ref=e123]
                - columnheader "Shooter" [ref=e124]
            - rowgroup [ref=e125]:
              - row [ref=e126]:
                - cell "Hit (non-lethal)" [ref=e127]
                - cell "headset green blink · hit tone (HP / armor / shield / crit each have their own) · gun LEDs" [ref=e128]
                - cell "nothing (no radio path for a plain hit)" [ref=e129]
              - row [ref=e130]:
                - cell "Kill" [ref=e131]
                - cell "headset green hold · death alarm · gun stops firing" [ref=e132]
                - cell [ref=e133]:
                  - strong [ref=e134]: green sight flash
                  - text: + "kill" callout; in gun-menu games also "double kill" etc. streak lines
              - row [ref=e135]:
                - cell "Same team, FF off" [ref=e136]
                - cell "nothing — the gun drops the shot" [ref=e137]
                - cell "nothing" [ref=e138]
              - row [ref=e139]:
                - cell "Miss (accuracy roll)" [ref=e140]
                - cell "headset lights + zip, 0 damage" [ref=e141]
                - cell "—" [ref=e142]
          - paragraph [ref=e143]:
            - text: "Source:"
            - link "protocol/brx-protocol.md" [ref=e144] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-protocol.md
            - text: §7o,
            - link "docs/sound-architecture.md" [ref=e145] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/sound-architecture.md
            - text: ","
            - link "docs/experiment-log.md" [ref=e146] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/experiment-log.md
            - text: (LED map entries 2026-08-27),
            - link "docs/reference/brx-extended-user-guide.md" [ref=e147] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/reference/brx-extended-user-guide.md
        - note [ref=e149]:
          - strong [ref=e150]: Every shot names its shooter.
          - paragraph [ref=e151]:
            - text: The 6-bit player id in the word is why a host can credit the
            - emphasis [ref=e152]: exact
            ...
            - emphasis [ref=e153]: Developer / IR protocol
            - text: .
          - paragraph [ref=e154]:
            - text: "Source:"
            - link "protocol/brx-ir-protocol.md" [ref=e155] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/protocol/brx-ir-protocol.md
            - text: §Why this matters,
            - link "docs/game-modes.md" [ref=e156] [cursor=pointer]:
              - /url: https://github.com/tony99nyr/open-brx/blob/main/docs/game-modes.md
            - text: (P2 closed note)
        - generic [ref=e157]:
          - figure "REAL PHOTO — a headset lit green mid-hit next to a tagger sight showing the kill-confirm flash." [ref=e158]:
            - img "REAL PHOTO — a headset lit green mid-hit next to a tagger sight showing the kill-confirm flash" [ref=e159]:
              - generic [ref=e160]: GAME-11
              - generic [ref=e161]: photo pending
          - paragraph [ref=e163]: "Source: this section"
  - contentinfo [ref=e164]:
    - paragraph [ref=e165]:
      - text: Protocol discovered by
      - link "LaserTagMods" [ref=e166] [cursor=pointer]:
    ...
    - paragraph [ref=e167]:
      ...
      - link "Credits & sourcing" [ref=e168] [cursor=pointer]:
        - /url: /credits/
      - text: ·
      - link "Changelog" [ref=e169] [cursor=pointer]:
        - /url: /changelog/
      - text: ·
      - link "llms.txt" [ref=e170] [cursor=pointer]:
        - /url: /llms.txt
      - text: ·
