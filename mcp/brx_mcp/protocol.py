...
KNOWN_COMMANDS: dict[str, CommandInfo] = {
    ...
    "BUMP": _c(5, True, "[bench 2026-09-18, F65: every field confirmed] [disasm, sheet, apk2018] $BUMP,<amount>,<hp 0/1>,<armour 0/1>,<shield 0/1>,<sound>: a cascade. Our 3-token probe was inert (no flag set); the armour flag is proven on the wire by the 2026-09-18 Callsign capture ($BUMP,12,,1,,,*)"),
    "STUN": _c(1, True, "[bench 2026-09-18] $STUN,<ms>: a native, SILENT timed stun (the node plays X17). Our bare $STUN,* was 0 ms"),
    "TMP": _c(11, True, "[bench 2026-09-18: t4-t9 over BLE; send all 12 commas] [disasm] pool-max bonuses t1-t3, incoming damage % t8, magazine % t9, default hit sound t11"),
    ...
    "IRTX": _c(11, True, "[bench 2026-09-18: the headset emits the word, and a dead gun forwards it] [sheet, apk2018] transmit one IR word; the gun relays it to the headset emitter [disasm]"),
