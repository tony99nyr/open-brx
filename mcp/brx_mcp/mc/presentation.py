...
EVENTS: dict[str, dict] = {
    ...
    "reload_nag":      dict(source="hud", group="player",  desc="empty magazine, reserve left, trigger pulled anyway: the 5th dry pull and every 3rd after it", sound="voice:reload_nag", gun_led=None, headset=None),  # VX73 by descriptor, NOT yet ear-confirmed
