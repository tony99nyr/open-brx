...
def headset_team_frame(team: int | None, ffa: bool = False, night: bool = False) -> str:
    ...
    Bench 2026-09-03 (historical, see experiment-log 2026-09-03; `hled_spawned.py`/`hled_bright.py`
    since deleted, doc-rot review 2026-09-12), gun DELTA-9498, operator watching:
