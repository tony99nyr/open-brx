...
def test_validate_grades_against_the_pool_the_gun_is_ARMED_with():
    ...
    # S50 (2026-09-17): body_armor's grant is now 20% of the pool (`compile._POOL_GRANT_PCT`), not a
    # flat +50 -- round(0.20*115) = 23.
    assert armed_pool(None) == 115 and armed_pool("body_armor") == 138
