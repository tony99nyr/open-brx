...
| **Per-player phone app (B2)** | ◐ kept as option | Works, but a dedicated cheap rider beats phones for a rental/club fleet: no BYOD, cheap to replace, ruggedizable, fleet-manageable (OTA/charging), no OS/app-store churn. B2 stays for personal/BYOD use or as the HUD. |
