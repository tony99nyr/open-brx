...
**Ids.** One capital letter + number. Never renumbered, never reused. **Next free: B32 · D6 · E8 · F259 · G11 · H9 ·
K9 · P19 · Q20 · R4 · S54.** (2026-09-18 evening, the drive integration on branch `jay-drive-integration`: **F254-F258** taken, the transport-hardening measures of `spec/transport-hardening.md` §8; F206 root-caused and its fix shipped, row kept open for the bench.) (2026-09-17 night: **S52** taken, the missing Easy Reload hint on the HUD; the fix/playtest-2026-09-13 branch renumbered its own rows and has
...
- **F65 🟡 `$BUMP` is inert on v4.32 — is that the command or our shape?** Bench 2026-09-09: `$BUMP,-5,0,0,*` on
  ...
  different arity, a different game state, or is it dead firmware? Low value — `$LIFE` covers the need. **→ 2026-09-18: it was the arity.** The V4_30 firmware, BC's own sheet and the 2018 BC app agree on `$BUMP,<amount>,<hp 0/1>,<armour 0/1>,<shield 0/1>,<sound>,*`: tokens 2-4 pick the pools, so our probes asked for nothing; a negative amount cascades shield → armour → HP and kills at 0, a positive one heals HP and spills outward. That is the one-command zone damage `$LIFE` cannot do. Raised to 🟡; `bench-firmware-levers-2026-09-19.md` §5. `trigger`.
...
- **Q15 🔴 → THE RANGE LEVER IS REAL, BUT IT IS `$WEAP` t2 `gunRangeOutdoor`, NOT t41 (garden, 2026-09-17).**
  ...
  **Shipped 2026-09-17 (outdoor only, `docs/weapon-design.md` §4.2):** Sniper 100; AMR/Charge Rifle 85; AR/Burst 70;
  ...
  (F228 is a close-range caveat only). See S48 for the HUD-driven venue control. Original row: sub-indoor IR power
