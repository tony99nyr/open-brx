...
**Ids.** One capital letter + number. Never renumbered, never reused. **Next free: B32 · D6 · E8 · F266 · G11 · H9 ·
K9 · P19 · Q20 · R4 · S54.** (2026-09-18 evening, the drive integration: **F261-F265** taken, the transport-hardening measures of `spec/transport-hardening.md` §8; they were filed on a branch as F254-F258 and moved at the merge because main had taken F254 and F260 and reserved F255-F259; F206 root-caused and its fix shipped, row kept open for the bench.) (2026-09-18: **F260** taken: the two-word weapons double-count HITS in the recap. F255-F259 belong to the fix/playtest-2026-09-13 branch. **F254** taken: at what `t13` value does the headset word (t12) stop
