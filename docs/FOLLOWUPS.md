...
- 🟡 **B28** · **B29** · **B30** · **D1** · **D4** · **F3** · **F13** · **F21** · **F26** · **F27** · **F28** · **F30** · **F39** · **F63** · **F66** · **F67** · **F68** · **F75** · **F76** · **F82** · **F88** · **F128** · **F131** · **F167** · **F168** · **F169** · **F195** · **F214** · **F216** · **F227** · **F229** · **F233** · **F262** · **F267** · **F270** · **F282** · **F285** · **F296** · **F298** · **G3** · **G10** · **H7** · **H8** · **K1** · **P3** · **P15** · **S1** · **S2** · **S7** · **S-A12** · **S36** · **S49** · **U11′**
...
- 🟡 **B1** · **B8** · **B14** · **B17** · **D1** · **D3** · **E3** · **E4** · **E6** · **F5** · **F16** · **F20** · **F24** · **F25** · **F42** · **F60** · **F68** · **F88** · **F95** · **F108** · **F109** · **F112** · **F113** · **F123** · **F126** · **F128** · **F130** · **F132** · **F133** · **F161** · **F176** · **F177** · **F186** · **F191** · **F221** · **F229** · **F233** · **F266** · **F267** · **F270** · **F281** · **F284** · **F289** · **F309** · **H1** · **H2** · **H6** · **H8** · **K2** · **Q12′** · **Q13** · **R3** · **S1** · **S2** · **S6** · **S7** · **S-A12** · **S13** · **S25** · **S27** · **S28** · **S29** · **S30** · **S31** · **S32** · **S36** · **S42** · **S43** · **S46** · **S47** · **S48** · **S49** · **S51**
...
- **F289 🟡 A PHONE THAT DIES INSIDE THE SPAWN-PROTECTION WINDOW MAY STAY PROTECTED ALL MATCH.** Filed 2026-09-18 (polish review #2, F121 gate work). F121's fix writes `$TMP` t8 = -100 right after `$SPAWN`, then the phone writes t8 = 0 (`spawn_protect_off`) on the first shot or at `SPAWN_PROTECT_MAX_MS` (2100 ms, `engine.js`), whichever comes first. The off-write is the PHONE's job, not the gun's own timer. If the phone loses power, crashes, or drops its BLE link inside that 2.1 s window, the off-write never goes out, and the gun keeps t8 = -100 for the rest of the match: that player takes no damage from anyone, and nothing on the MC board says so. Out of scope for this review's fix (`_bind`/`_hydrate`/`start()` app-version gate); this is a DIFFERENT hole in the same mechanism. **2026-09-23: Tony chose the MC board flag. The node half is on main**: the `respawn` fact (and an infection flip's `team_change`) carries `protect_ms`, and status carries `protected: true` while the phone owes the end write. Only a RECONNECT ends protection (the reconcile path, after a BLE drop or an app restart); a phone that stays offline cannot, which is what the flag is for. Do: the MC half (brx3): show POSSIBLY PROTECTED, amber and never a blocker, for an OFFLINE player whose newest evidence says the protection was not ended.
...
- **S56 🟡 WHAT HIT ME: A HIT TAG AND A DEATH RECAP.** Tony 2026-09-23: show the weapon on every hit ("it answers what did I get hit by"), and a video-game death screen with damage dealt, damage taken, and their sources, so a player can change tactics. The phone already latches the shooter, magnitude, crit and IR protocol from each `$HIR`; it does not know the shooter's weapon. Plan: MC adds each player's loadout weapon ids to `RosterEntry`; the engine resolves shooter + magnitude to a weapon (catalogue fallback for pickups) and books damage taken per source per life. Damage DEALT is invisible on the shooter's own gun (manual: a scored hit never reaches your stream), so it can only come from the victims' facts relayed by MC, best-effort: the recap must say so when it is partial. HUD visuals go to the brx-hud session. `build`.
...
- **F309 🟡 COVERAGE NEEDS THE PHONE'S OWN TRANSPORT.** F256's conservative fix stops MC deriving FULL coverage from `reach`, which names only the URL a phone joined through; `coverage.level` is now always `zones`. The real fix: the node reports its own transport (Capacitor Network `connectionType`: `wifi` / `cellular`) in `hello` and `status`, and `Session.coverage()` counts only a node on backhaul over an INDEPENDENT transport. Touches `app/src` (the hello), `envelope.py`, `state.py coverage()` and the three fakes (F251). Until then the A6.1 frag-limit warning stays on every tunnel game. Also in scope: the A31 "WIN IS CONFIRMED AT MC" warning (`compile.py mc_verify`, `state.py _off_grid()`) still disappears when every phone joined through the tunnel, on the same reach-based trust. `build`.
