...
- **S59 🟡 HALO SHIELD HUD.** Tony 2026-09-24: a Halo-style shield meter (the primary vital, blue; red when broken; the recharge delay shown; a green overshield layer by day, shape and brightness at night). Variants on branch `shield-halo` and a static gallery for Tony's pick; open question on the gallery: should the overshield decay? `design`.
