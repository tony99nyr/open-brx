...
**Ids.** One capital letter + number. Never renumbered, never reused. **Next free: B32 · D6 · E8 · F225 · G11 · H9 ·
K9 · P19 · Q20 · R4 · S42.** (2026-09-17 bench pass on the same playtest: **F206, F207, F212, F213, F210, F211**
...
- **F217 🟠 Needs Tony at the bench** confirm A44 spawn protection on hardware. Shoot a respawned player within 2 s: no damage. Shoot after their first shot, or after about 3 s: normal damage. `trigger`.
- **F218 🟠 Needs Tony at the bench** A45 `no_fire` must not fire on a charge-rifle hold, and must not fire on a swap to an empty slot. `trigger`.
