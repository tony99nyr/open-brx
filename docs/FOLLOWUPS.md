...
- 🟢 **B20** · **F29** · **F87** · **F99** · **F111** · **F114** · **F120** · **F250** · **F273** · **G4** · **P4** · **P12** · **S8**
...
- **F276 🔴 OUR SHOTGUN PRICES BOTH WORDS AT 20, AND IDENTICAL WORDS MAY DEDUPE NATIVELY.** Filed 2026-09-18 from
  ...
  applies only to the barrel word, so a crit would break the match. None does today. Cross-ref F260, F263, F71, and F275 (the headset word's own reach). `bench`.
