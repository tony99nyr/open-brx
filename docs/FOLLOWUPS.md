...
- **F320 🟠 S57 MAY COLLIDE WITH THE NATIVE PROTOCOL-15 KILL WORD.** Code read, not bench-proven (596122ea; `firmware-image-research-plan.md`, the 2026-09-23 log): the v4.32 gun and the v1.27/v1.34 headsets act on protocol-15 magnitudes 0-3 in their own ways, and magnitude 2 is the native kill word, which the headset appears to send on a fatal hit (one native capture, 2026-09-04, source unknown, saw it). S57 puts the victim's team (0-3) in the magnitude, so a hosted kill could produce a stray (15,2) that S57 guns log as a callout. Bench: a hosted kill with the ESP32 receiver beside the victim's headset, logging every protocol-15 word (`bench-2026-09-24.md` Block 2b). If the word appears, move S57's magnitude map off 0-3. Cross-ref S57, R4. `bench` + `build`.
