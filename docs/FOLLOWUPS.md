...
- **F280 🟠 THE RECOIL RUNGS DO NOT SCALE WITH THE MAGAZINE, SO A DEEP-POOL WEAPON IS AT HEAVY FOR ITS WHOLE LIFE.**
  ...
  weapon and a 300-round one. Options, none costed: scale the rungs as a FRACTION of the magazine; give the deep
  weapons their own rung counts; or accept that a 300-round battery weapon is meant to be inaccurate under sustained
  fire and say so out loud in its design rather than by accident. ⚠️ This is a NUMBERS row, not a mechanism row: it
