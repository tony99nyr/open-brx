...
| **Night mode** (outdoor + LEDs off) | `outdoor=True, leds=False` | `$GSET` + `$GLED,,,,5,,,*` ✅ (P17 closed 2026-08-30; corrected 2026-09-02 — **token 4 is an apply gate**, and this frame blanks because its colour tokens are empty and t4=5 applies them, not because 5 means "off") |
...
⚠ **Note:** LEDs-off (`$GLED`) is **confirmed** (P17 closed 2026-08-30 — `$GLED,,,,5,,,*` blanks all three because **token 4 is an apply gate** and the frame's colour tokens are empty; corrected 2026-09-02, and the earlier "t4=3 blanks" reading stays retracted because 3 is a no-op); shields are inactive until
