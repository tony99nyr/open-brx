...
- **Kind:** GENERATE
- **Source:** protocol/brx-protocol.md §7o
...
| GAME-09 | `03-gameplay.md` | health / diagram | Three stacked pools (shield, armor, health) draining top-down, with one large hit overflowing from the armor bar into the health bar | protocol/brx-protocol.md §7r addendum |
