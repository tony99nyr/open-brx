...
- **Damage over time.** The Toxin Rifle poisons on every hit, and the poison keeps draining health for a few seconds after the target breaks contact. It is the answer to walking away, and therefore the natural counter to denial.
