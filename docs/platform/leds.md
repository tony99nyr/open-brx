...
|---|---|---|
| 6 | all three solid | green |
| 5 | LEDs 2 and 3 solid, LED 1 blinking | green |
| 4 | LEDs 2 and 3 solid | green |
| 3 | LED 3 solid, LED 2 blinking | yellow |
| 2 | LED 3 solid | yellow |
| 1 | LED 3 blinking | red |
| 0 | dark | (empty) |
