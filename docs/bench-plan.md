...
**Block 0 (preflight), Block 1 (F297/F293 connect reliability), and Block 3.1-3.2 (F308: release order, fire
intervals) are DONE, 2026-09-24** (see the experiment log's 2026-09-24 bench entry). Step 1.3 was not needed as
a planned step: the loop was reproduced on demand, without a btsnoop capture. **The next sitting starts at Block
3.3.** What remains: the rest of F308's bench items in `docs/weapon-design.md`'s Balance rules table, the
screamers transport steps A4, A7, A7b, A7c and A8 with `raw-bytes` (F269/F270), the native kill word and the R4
readings (Block 2b: F320-F322), S56, F292, F298, F296, F309, F275
