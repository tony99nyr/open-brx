# BRX 3D print files — the market survey
...
This page is the **research**: who has what, who sells it, and the adjacent parts. What *we* intend to
print, and the measurement that blocks it, is [`../../hardware/print-files.md`](../../hardware/print-files.md).
...
- **IR receiver** the community IDs on the BRX is a Vishay **TSSP38 / TSSP77P38** (38 kHz) — the part
  ...
  the 25-bit / 38 kHz IR tag encoding in `lasertagmods.md`.
