# HANDOFF history (archived 2026-09-06)

The dated banners and snapshot sections that used to sit in `docs/HANDOFF.md`, moved here verbatim,
newest first, when HANDOFF was cut to a one-screen state page. Not maintained. Each banner names the
`experiment-log.md` entry it summarises; that entry is the record. The sections after the banners are the
2026-08-23 to 2026-08-26 snapshots ("Where the project stands", the CLI list, the APK/sound-inventory
notes, environment, hardware facts) as they were on 2026-09-04.
...
## Snapshot sections (as of 2026-09-04)
