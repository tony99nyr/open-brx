# Pre-2026-09-06 followups snapshot (archive)

Everything moved out of `docs/archive/followups-closed.md` on 2026-09-12 that predates its
one-dated-line-per-closed-item format: five bulk historical dumps from before the 2026-09-06 docs
consolidation. Rows in here marked open or unresolved are a disclaimed 2026-09-04 snapshot, not current
status — **not maintained; grep it, do not read it**. The living files win: `docs/manual/`,
`docs/spec/contracts.md`, `protocol/brx-protocol.md`, `docs/FOLLOWUPS.md`.
