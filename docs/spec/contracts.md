...
Event =
 ...
 |   // shooter's weapons share a magnitude). MC forwards it verbatim in the `feedback{kind:"hit"}` relay
...
Network `connectionType`); absence or junk clears the last claim. An independent path is BOTH facts: `reach` (MC's
