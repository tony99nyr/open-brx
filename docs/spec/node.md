...
|---|---|---|---|---|---|---|
| assault_rifle | 100 | 70 | 45 | 6 | 7 | 600 |
...
holds (the chip bar hides under them); **moments** are transient: HIT and GAIN stack over RELOADING and SWITCHING,
and wait out DOWN and RECONCILING. The kill card is a lane, and a due one waits for any takeover to end.
