...
variety is by hit TYPE, and slot 6 (hurt loop) is now the critical-health line. Both builds (A15.2 spawn line, A15.3) were
verified in the browser against the fake gun and the suites were green before the live stage was restarted.
