...
/** @typedef {{get():Promise<{enabled:boolean}>, set(o:{enabled:boolean}):Promise<{enabled:boolean}>}} DebugPlugin */
...
export class WebDebug {
  ...
  async toggle() {
    if (!this.plugin || this.busy || this.state === null) return this.state;
    this.busy = true;
    try {
