  ...
  if (stageName != null) {
    ...
    const ev = {
      ...
      resultAwards: () => ev.result('win', { honors: [
        { medal: 'MVP', key: 'mvp', player_id: 'p-demo', display: 'REAPER', stat: '11 K · 2.8 K/D · ×3 STREAK' },
        { medal: 'MOST KILLS', key: 'most_kills', player_id: 'p-demo', display: 'REAPER', stat: '11 ELIMINATIONS' },
        { medal: 'MOST KILLS', key: 'most_kills', player_id: 'p-2', display: 'VIPER', stat: '11 ELIMINATIONS' },
        { medal: 'BEST K/D · NON-MVP', key: 'best_kd', player_id: 'p-2', display: 'VIPER', stat: 'K/D 2.2 · 9 K' },
        { medal: 'SHARPSHOOTER', key: 'sharpshooter', player_id: 'p-2', display: 'VIPER', stat: '41% ACCURACY' },
        { medal: 'SURVIVOR', key: 'survivor', player_id: 'p-demo', display: 'REAPER', stat: 'LONGEST LIFE 4:12' },
        { medal: 'IRON MAN', key: 'iron_man', player_id: 'p-3', display: 'HAVOC', stat: 'FEWEST DEATHS · 1' },
        { medal: 'FIRST BLOOD', key: 'first_blood', player_id: 'p-2', display: 'VIPER', stat: 'AT 01:12' },
        { medal: 'MULTIKILL', key: 'multikill', player_id: 'p-3', display: 'HAVOC', stat: 'TRIPLE KILL ×2' },
        { medal: 'WINGMAN', key: 'wingman', player_id: 'p-3', display: 'HAVOC', stat: '6 ASSISTS' },
        { medal: 'OBJECTIVE HERO', key: 'objective_hero', player_id: 'p-2', display: 'VIPER', stat: 'IN RANGE · 2:48' }] }),
