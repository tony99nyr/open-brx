...
export declare const NEVER_SEEN_MS: 1000000000;
...
export declare const VENUE_VOLUME_INDOOR: 80;
...
export declare const STATION_LOCK_MAX_S: 7200;
export declare const STATION_LOCK_LOBBY_S: 1800;
export declare const STATION_LOCK_MARGIN_S: 120;
/** a boot instant (t_recv - uptime_s) that moves further than this is a new boot */
export declare const STATION_REBOOT_SLACK_MS: 5000;
...
export declare const STATION_EDIT_AGE_UNKNOWN_MS: 86400000;
...
export declare const ADOPT_SLACK_MS: 10000;
/** net.md §8 size cap */
...
export type PersistedEventType = 'death' | 'hit_taken' | 'operator_result' | 'pickup' | 'possession' | 'respawn' | 'team_change';
...
export interface NodeView {
  ...
  pool_stale?: 'silent' | 'no_fire' | 'write_lost' | 'pool_wrong';
...
export interface ReadinessRow {
  ...
  pool_stale: 'silent' | 'no_fire' | 'write_lost' | 'pool_wrong' | null;
