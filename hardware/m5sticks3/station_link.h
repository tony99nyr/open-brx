...
struct StationAssignment {
  ...
  int id = 0;
  int threshold = -60;  // dBm; parse_station_config resolves 0/absent to STICK_DEFAULT_THRESHOLD_DBM
...
// -60 dBm, the StickS3's platform default (Tony, 2026-09-24: 3 m at most; a Stick is louder than a phone). It is
...
constexpr int STICK_DEFAULT_THRESHOLD_DBM = -60;  // = PRESENCE_DEFAULT_THRESHOLD_DBM (Tony: 3 m at most)
...
// 0/absent, the StickS3's own platform default (-60 dBm, Tony's 3 m), measured and advertised alike.
// The advertised byte 14 is the same -60
