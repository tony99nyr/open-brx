...
EXPECT: dict[str, dict] = {
    ...
    "stats_range_cue_locked": {"kind": "SCR_STATS", "has": ["STATS", "CONTROL #3"], "lacks": ["HOLD FOR RANGE"]},
    "stats_range_cue_locked": {"kind": "SCR_STATS", "has": ["STATS", "CONTROL #3"], "lacks": ["HOLD FOR RANGE"]},
    "range_radius_default": {"kind": "SCR_RANGE", "has": ["RADIUS", "STRENGTH", "-75", "5-7 M", "HIGH", "+9 dBm",
                                                          "A CLOSER  B FARTHER", "HOLD B: DONE"], "lacks": ["EDITED"]},
    "range_radius_closer": {"kind": "SCR_RANGE", "has": ["-72", "5-7 M", "EDITED"]},
    ...
    "range_locked": {"kind": "SCR_RESET_LOCKED", "has": ["LOCKED", "MATCH IN PROGRESS"], "lacks": ["RADIUS"]},
    ...
    "range_released": {"kind": "SCR_STATS", "has": ["STATS"], "lacks": ["RADIUS"], "same_as": "welcomed_stats"},
