...
Download: https://open-brx.iamrossi.workers.devhttps://github.com/tony99nyr/open-brx/releases/download/app-v0.1.7/brx-companion-0.1.7-android-debug.apk (5.4 MB, version 0.1.7, built 2026-09-07, sha256 be23524e4a60eec941383d760a97a2c99ee586a053d7086f6aa62b68f0e07189)
...
## Install it
1. **Get the APK onto the phone.** Tap the download button above on the phone itself, or download on a computer and copy the file across. Any transfer works. The button points at the build's GitHub release; while this repo is private that link needs repo access, so it will not open for everyone yet. 🚧
