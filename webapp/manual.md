...
## Search first.
⌘K / the search box indexes every heading, weapon, sound id, command, and FAQ.

## How we source and verify
3 short items: (1) restate, don't copy — official PDFs are linked, not rehosted; (2) confidence badges on every block; (3) sources link to the open repo so you can check our work. → `/credits`
Source: docs/VISION.md §Sourcing/policy
