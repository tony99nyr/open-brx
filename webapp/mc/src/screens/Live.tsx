...
export function Live() {
  ...
  // A41 (field 2026-09-12, twice: a tagger played on after the operator ended the match). The retry is
...
function Row({ r, endUnconfirmed }: { r: LiveRow; endUnconfirmed?: boolean }) {
  ...
  return (
    <div data-end-unconfirmed={endUnconfirmed ? r.player_id : undefined}
      ...
      {/* A41: the END overrides ALIVE/LAST KNOWN here on purpose. Once the match is over, whether this
