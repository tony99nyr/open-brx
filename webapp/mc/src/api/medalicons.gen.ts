// GENERATED by app/scripts/gen-medalicons.mjs from app/src/hud/medalicons.js -- do not edit; run node app/scripts/gen-medalicons.mjs
// @ts-nocheck -- the source is plain JS; MC uses medalIcon(key, { size, label }) and medalChip(text, rows), which return strings
// ---- app/src/hud/medalicons.js, verbatim ----
