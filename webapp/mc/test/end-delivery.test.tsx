// A41 — the operator's half: did the END actually land on every player's HUD?
//
...
describe('A41 · LIVE tells the operator who has not confirmed the end', () => {
...
describe('A41 · RECAP names it as a delivery fact, never as a score', () => {
