...
Label each gun and its headset as a pair — a strip of tape or a sticker with the same mark on both. Stock taggers are identical and unlabeled, and a mixed-up pair is the most common reason "my gun won't fire" at a party.
