...
Source: protocol/session-findings-2026-08.md §7c; docs/experiment-log.md (2026-08-24 B7)
...
Source: protocol/session-findings-2026-08.md §7c; protocol/callsign-extract/protocol-classes.md ("New sounds ON THE TAGGER")
...
```
Source: protocol/session-findings-2026-08.md §7c (values are one unit's; PIN/serial redacted)
...
Source: protocol/session-findings-2026-08.md §7c, §7p; docs/experiment-log.md (2026-08-24)
...
Source: protocol/session-findings-2026-08.md §7b, §7c
