...
Source: protocol/callsign-extract/protocol-classes.md (WEAP exact token positions + cap14–cap24 sections), protocol/brx-protocol.md §6.1 and the t20 / overheat sections, docs/experiment-log.md (2026-08-26 $WEAP token probes; charge modes; overheat solved)
