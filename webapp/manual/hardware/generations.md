...
Source: protocol/brx-protocol.md §1, protocol/session-findings-2026-08.md §7a, §7r, docs/reference/brx-extended-user-guide.md, docs/reference/lasertagmods.md
...
Source: docs/reference/community-notes.md, protocol/session-findings-2026-08.md §7b, §7c
